...
4. Copy the token and use it for authentication in the next request. Create a new POST request to: https://lightup-38603a824c6f.herokuapp.com/fundraisers/. On this request # Crowdfunding Back End
Jessica Keating
